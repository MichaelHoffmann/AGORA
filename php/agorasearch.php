<?php
	...
	*/
	...
	function search_db($query,$type,$queryC){
		...
		//Query passed in gets used here.
		$resultIDC = mysql_query($queryC, $linkID);
		if(!$resultIDC){
			dataNotFound($output, $queryC);
			return $output;
		}
		if($resultIDC!=null && mysql_num_rows($resultIDC)>0){
				$row = mysql_fetch_assoc($resultIDC);
	...
	$type = mysql_real_escape_string($_REQUEST['searchType']);  //TODO: Change this back to a GET when all testing is done.
	...
	$start = mysql_real_escape_string($_REQUEST['index']);  //TODO: Change this back to a GET when all testing is done.
	$s2Query = "";
	$uvname = "";
	...
	if (array_key_exists("uvname", $_REQUEST)) {
		$uvname = mysql_real_escape_string($_REQUEST['uvname']);  //TODO: Change this back to a GET when all testing is done.
	}
	$b1 = mysql_real_escape_string($_REQUEST['b1']);  //TODO: Change this back to a GET when all testing is done.
	$b2 = mysql_real_escape_string($_REQUEST['b2']);  //TODO: Change this back to a GET when all testing is done.
	
	$dateC = mysql_real_escape_string($_REQUEST['dateC']);  //TODO: Change this back to a GET when all testing is done.
	$dateM = mysql_real_escape_string($_REQUEST['dateM']);  //TODO: Change this back to a GET when all testing is done.

	$sortBy = mysql_real_escape_string($_REQUEST['sortBy']);  //TODO: Change this back to a GET when all testing is done.
	$order = mysql_real_escape_string($_REQUEST['order']);  //TODO: Change this back to a GET when all testing is done.
