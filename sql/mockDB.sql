...
INSERT INTO arguments (map_id, user_id, node_id, type_id, created_date, modified_date) VALUES
	(1, 1, 2, (SELECT type_id FROM connection_types WHERE conn_name="MPtherefore"), NOW(), NOW()),
	(1, 1, 3, (SELECT type_id FROM connection_types WHERE conn_name="ConSyllogism"), NOW(), NOW());
