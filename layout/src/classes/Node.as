...
package classes
{
	...
	public class Node extends Panel
	{
		...
		public function Node()
		{
			...
			this.addEventListener(FlexEvent.CREATION_COMPLETE,onNodeCreate);
		...
		public function beginDrag( mouseEvent: MouseEvent ):void
		{
			try{
				...
				var dPInitiator:Node = Node(dinitiator.parent.parent.parent.parent.parent);
		...
		public function addReasonHandler(event:MouseEvent):void
		{
			...
			var linkedBox:Node = Node(mystage.parent.parent.parent.parent.parent.parent.parent.parent.parent.parent);
		...
		public function linkBoxes(a:Node,b:Node,g:Group):void
		{
		...
		override protected function createChildren():void{
			...
			//this.input1.addEventListener(FlexEvent.CREATION_COMPLETE,onNodeChildrenCreate);
			//this.input2.addEventListener(FlexEvent.CREATION_COMPLETE,onNodeChildrenCreate);
			//this.topArea.addEventListener(FlexEvent.CREATION_COMPLETE,onNodeChildrenCreate);
		...
		public function onNodeCreate( e:FlexEvent):void
		{
