...
internal class _UsersEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    ...
    model_internal static var allProperties:Array = new Array("lastName", "email", "userLevel", "userName", "user_id", "firstName", "createdDate", "password");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array("lastName", "email", "userLevel", "userName", "user_id", "firstName", "createdDate", "password");
    model_internal static var allAlwaysAvailableProperties:Array = new Array("lastName", "email", "userLevel", "userName", "user_id", "firstName", "createdDate", "password");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("lastName", "email", "userLevel", "userName", "user_id", "firstName", "createdDate", "password");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
     ...
     override public function getIdentityMap():Object
     {
         ...
         returnMap["user_id"] = model_internal::_instance.user_id;
