package ValueObjects
{
	...
	public class AGORAParameters
	{
		...
		{
			//Server URLS - check this if you get 'Network Error'
			...
			mapPermURL = "http://agora.gatech.edu/release/mapPermissionsCheck.php";
			...
			forgotpasswordURL="http://agora.gatech.edu/release/forgot_pass.php";
			...
			saveMapAsUrl = "http://agora.gatech.edu/release/saveMapAs.php";
			catChainURL = "http://agora.gatech.edu/release/projectHierarchy.php";
			searchURL = "http://agora.gatech.edu/release/agorasearch.php";
			searchShowURL = "http://agora.gatech.edu/release/agorashowsearch.php";
